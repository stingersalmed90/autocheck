...
public class AdminController {
    ...
    public String editarInventario(@PathVariable(required = true) Long id, Model model) {
    ...
    public String actualizarInventario(@PathVariable(required = true) Long id, @ModelAttribute Inventario inventario) {
    ...
    public String cambiarEstadoInventario(@PathVariable(required = true) Long id) {
